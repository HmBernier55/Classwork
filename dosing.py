...
def parse_input(diagnosis, weight_input):
...
def calculate_dosage(diagnosis, weight, units):
    if units == "lb"
        weight = weight / 2.205
...
if __name__ == '__main__':
    ...
    weight, units = parse_input(diagnosis, weight_input)
    weight, dosage_mg_first_day = calculate_dosage(diagnosis, weight, units)
